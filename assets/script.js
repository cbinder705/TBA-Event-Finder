...
$.ajax({
  type: "GET",
  url: "https://app.ticketmaster.com/discovery/v2/events.json?size=5&city=Camden&apikey=25HXWz0Ao4txUIjAm8EGenva5u1M7pt0",
  async: true,
  dataType: "json",
  ...
  function DisplayEvents(data) {
    ...
    console.log(data._embedded.events[0].name[0]);
